  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="author" content="Lakshya Sanghi" />
        <meta property="og:image" content="https://github.com/Lexisan007" />
        <meta
          property="og:url"
          ...
          {selectBtn ? (
            <>
              ...
              <Text color={"gray.500"} maxW={"3xl"}>
                ...
                resume in a few easy steps. This resume builder offer different
                template options, so you can select the template that best fits
